...
__gitcomp_builtin_bisect_default=" reset terms start next log replay skip visualize view run"
...
__gitcomp_builtin_bugreport_default=" --diagnose --output-directory= --suffix= --no-diagnose -- --no-output-directory --no-suffix"
__gitcomp_builtin_bundle_default=" create verify list-heads unbundle"
__gitcomp_builtin_cat_file_default=" --allow-unknown-type --use-mailmap --batch --batch-check --batch-command --batch-all-objects --buffer --follow-symlinks --unordered --textconv --filters --path= --no-allow-unknown-type -- --no-use-mailmap --no-mailmap --no-buffer --no-follow-symlinks --no-unordered --no-path"
__gitcomp_builtin_check_attr_default=" --all --cached --stdin --source= --no-all -- --no-cached --no-stdin --no-source"
...
__gitcomp_builtin_clone_default=" --verbose --quiet --progress --reject-shallow --no-checkout --bare --mirror --local --no-hardlinks --shared --recurse-submodules --jobs= --template= --reference= --reference-if-able= --dissociate --origin= --branch= --upload-pack= --depth= --shallow-since= --shallow-exclude= --single-branch --no-tags --shallow-submodules --separate-git-dir= --config= --server-option= --ipv4 --ipv6 --filter= --also-filter-submodules --remote-submodules --sparse --bundle-uri= --checkout --hardlinks --tags -- --no-verbose --no-quiet --no-progress --no-reject-shallow --no-bare --no-mirror --no-local --no-shared --no-recurse-submodules --no-recursive --no-jobs --no-template --no-reference --no-reference-if-able --no-dissociate --no-origin --no-branch --no-upload-pack --no-depth --no-shallow-since --no-shallow-exclude --no-single-branch --no-shallow-submodules --no-separate-git-dir --no-config --no-server-option --no-ipv4 --no-ipv6 --no-filter --no-also-filter-submodules --no-remote-submodules --no-sparse --no-bundle-uri"
...
__gitcomp_builtin_commit_graph_default=" verify write --object-dir= --no-object-dir"
__gitcomp_builtin_commit_tree_default=" --gpg-sign --no-gpg-sign"
...
__gitcomp_builtin_diagnose_default=" --output-directory= --suffix= --mode= --no-output-directory -- --no-suffix"
...
__gitcomp_builtin_help_default=" --all --external-commands --aliases --man --web --info --verbose --guides --user-interfaces --developer-interfaces --config --no-external-commands -- --no-aliases --no-man --no-web --no-info --no-verbose"
__gitcomp_builtin_hook_default=" run"
...
__gitcomp_builtin_log_default=" --quiet --source --use-mailmap --clear-decorations --decorate-refs= --decorate-refs-exclude= --decorate --no-quiet -- --no-source --no-use-mailmap --no-mailmap --no-decorate-refs --no-decorate-refs-exclude --no-decorate"
__gitcomp_builtin_ls_files_default=" --cached --deleted --modified --others --ignored --stage --killed --directory --eol --empty-directory --unmerged --resolve-undo --exclude= --exclude-from= --exclude-per-directory= --exclude-standard --full-name --recurse-submodules --error-unmatch --with-tree= --abbrev --debug --deduplicate --sparse --format= --no-cached -- --no-deleted --no-modified --no-others --no-ignored --no-stage --no-killed --no-directory --no-eol --no-empty-directory --no-unmerged --no-resolve-undo --no-exclude-per-directory --no-recurse-submodules --no-error-unmatch --no-with-tree --no-abbrev --no-debug --no-deduplicate --no-sparse"
...
__gitcomp_builtin_mailinfo_default=" --message-id --encoding= --scissors --quoted-cr= --no-message-id -- --no-scissors"
__gitcomp_builtin_maintenance_default=" run start stop register unregister"
...
__gitcomp_builtin_merge_tree_default=" --write-tree --trivial-merge --messages --name-only --allow-unrelated-histories --stdin --merge-base= --no-messages -- --no-merge-base"
__gitcomp_builtin_mktag_default=" --strict --no-strict"
__gitcomp_builtin_mktree_default=" --missing --batch --no-missing -- --no-batch"
__gitcomp_builtin_multi_pack_index_default=" repack write verify expire --object-dir= --no-object-dir"
...
__gitcomp_builtin_revert_default=" --quit --continue --abort --skip --cleanup= --no-commit --edit --signoff --mainline= --rerere-autoupdate --strategy= --strategy-option= --gpg-sign --reference --commit -- --no-cleanup --no-edit --no-signoff --no-mainline --no-rerere-autoupdate --no-strategy --no-strategy-option --no-gpg-sign --no-reference"
...
__gitcomp_builtin_show_default=" --quiet --source --use-mailmap --clear-decorations --decorate-refs= --decorate-refs-exclude= --decorate --no-quiet -- --no-source --no-use-mailmap --no-mailmap --no-decorate-refs --no-decorate-refs-exclude --no-decorate"
...
__gitcomp_builtin_sparse_checkout_default=" list init set add reapply disable"
...
__gitcomp_builtin_stash_default=" apply clear drop pop branch list show store create push"
...
__gitcomp_builtin_symbolic_ref_default=" --quiet --delete --short --recurse --no-quiet -- --no-delete --no-short --no-recurse"
...
__gitcomp_builtin_whatchanged_default=" --quiet --source --use-mailmap --clear-decorations --decorate-refs= --decorate-refs-exclude= --decorate --no-quiet -- --no-source --no-use-mailmap --no-mailmap --no-decorate-refs --no-decorate-refs-exclude --no-decorate"
__gitcomp_builtin_worktree_default=" add prune list lock unlock move remove repair"
